                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    if (FFAppState().isProductListShow == false)
                                      Builder(
                                        builder: (context) {
                                          final list = _model
                                              .simpleSearchResults
                                    ...
                                    if (FFAppState().isProductListShow == true)
                                      Builder(
                                        builder: (context) {
                                          final containerVar =
                                              containerProductRecordList
