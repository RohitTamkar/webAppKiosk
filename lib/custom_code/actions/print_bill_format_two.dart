...
//PRODUCT PRINT START
      ...
      String itemsNo = "Total Qty :" + len.toString();
      printLine = itemsNo;
...
// Initialize running totals
  ...
  double totalTax = double.parse(obj["itemList"][i]["taxAmt"].toString());*/
        ...
        // bytes+=generator.text( "SGST 2.5%: "+ (sgstTotal.roundToDouble()).toString(),
        bytes += generator.text("SGST 2.5%: " + sgstTotal.toStringAsFixed(1),
            styles: const PosStyles(
              height: PosTextSize.size1,
              width: PosTextSize.size2,
              bold: false,
        ...
        bytes += generator.text("CGST 2.5%: " + cgstTotal.toStringAsFixed(1),
            styles: const PosStyles(
              height: PosTextSize.size1,
              width: PosTextSize.size2,
              bold: false,
        ...
        // bytes += generator.row([
        //   PosColumn(
        //     text: "SGST 2.5%:"+ (sgstTotal.roundToDouble()).toString(),
        //     width: 8,
        //     styles: PosStyles(
        //         fontType: PosFontType.fontA,
        //         height: PosTextSize.size2,
        ...
        // bytes+=generator.row([
        //   PosColumn(
        //     text: "CGST 2.5%:"+ (cgstTotal.roundToDouble()).toString(),
        //     width: 8,
        //     styles: PosStyles(
        //         fontType: PosFontType.fontA,
        //         height: PosTextSize.size2,
...
// Generating rows for each tax group
      ...
      bytes += generator.text("GRANT TOTAL:" + FFAppState().finalAmt.toString(),
          styles: PosStyles(
              height: PosTextSize.size2,
              width: PosTextSize.size2,
              align: PosAlign.right));
