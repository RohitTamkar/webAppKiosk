...
Future printCategoryWiseSalesReport(
  List<dynamic> data,
  ...
  if (size == 46) {
    ...
    if (data.length > 0) {
      ...
      bytes += generator.text("Category Wise Sales ",
          styles: PosStyles(
      ...
      for (int i = 1; i <= (size - (title.length + saleDate.length)); i++) {
        printLine += " ";
      }
      ...
      for (int i = 0; i < obj.length; i++) {
        for (int j = 0; j < obj[i]["products"].length; j++) {
          bytes += generator.row([
            PosColumn(
              text: obj[i]["products"][j]["name"].toString(),
              width: 6,
              styles: PosStyles(
            ...
            PosColumn(
              text: obj[i]["products"][j]["quantity"].toString(),
              width: 2,
              styles: PosStyles(
                  height: PosTextSize.size1,
                  width: PosTextSize.size1,
            ...
            PosColumn(
              text: obj[i]["products"][j]["price"].toString(),
              width: 2,
              styles: PosStyles(
                  height: PosTextSize.size1,
                  width: PosTextSize.size1,
            ...
            PosColumn(
              text: obj[i]["products"][j]["total"].toString(),
              width: 2,
              styles: PosStyles(
                  height: PosTextSize.size1,
                  width: PosTextSize.size1,
        ...
        bytes += generator.row([
          PosColumn(
            text: obj[i]["category"]["catName"].toString(),
            width: 6,
            styles: PosStyles(
                height: PosTextSize.size1,
                width: PosTextSize.size1,
          ...
          PosColumn(
            text: "Total: " + obj[i]["category"]["catTotal"].toString(),
            width: 6,
            styles: PosStyles(
                fontType: PosFontType.fontA,
                height: PosTextSize.size1,
    ...
    if (data.length > 0) {
      ...
      bytes += generator.text("Category Sale",
          styles: PosStyles(
              height: PosTextSize.size2,
              width: PosTextSize.size2,
              align: PosAlign.center));
      ...
      for (int i = 0; i < obj.length; i++) {
        for (int j = 0; j < obj[i]["products"].length; j++) {
          if (obj[i]["products"][j]["name"].toString().length >= 15) {
            bytes += generator.row([
              PosColumn(
                text: obj[i]["products"][j]["name"].toString(),
                width: 10,
