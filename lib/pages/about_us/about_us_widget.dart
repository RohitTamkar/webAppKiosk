                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              FFAppState().htmlview =
                                  '<!DOCTYPE html><html lang=\"en\"><head>    <meta charset=\"UTF-8\">    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">        <style>        body {            font-family: Arial, sans-serif;            margin: 0;            padding: 0;            line-height: 1.6;            color: #333;        }        header {            background: #f4f4f4;            padding: 20px;            text-align: center;            font-size: 24px;        }        .container {            padding: 20px;        }        h1, h2 {            color: #444;        }        ul {            list-style: disc;            margin: 10px 0 10px 20px;        }    </style></head><body>    <header>       Shipping And Delivery Policy    </header>    <div class=\"container\">                                     <ul>            <li>Delivery is available within the specified areas.</li>            <li>Estimated delivery times are provided but may vary due to unforeseen circumstances.</li>            <li>Pickup orders must be collected within the specified time frame mentioned during the checkout process.</li>        </ul>           </div></body></html>';
                              safeSetState(() {});
