...
import 'response_page_copy_model.dart';
export 'response_page_copy_model.dart';

class ResponsePageCopyWidget extends StatefulWidget {
  const ResponsePageCopyWidget({
    super.key,
    this.doc,
    this.shiftdetails,
    this.appsetting,
...
class _ResponsePageCopyWidgetState extends State<ResponsePageCopyWidget>
    with TickerProviderStateMixin {
  late ResponsePageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResponsePageCopyModel());
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          '0wfm29km' /* If bill is not printed click h... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
