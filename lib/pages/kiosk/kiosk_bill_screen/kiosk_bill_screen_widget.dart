                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              FFAppState().categoryColor =
                                                  'ALL';
                                              safeSetState(() {});
                                              _model.productDoc = _model.prodoc!
                                                  .toList()
                                                  .cast<ProductRecord>();
                                              safeSetState(() {});
                                            },
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        functions.loadDefaultList(FFAppState().selBill, FFAppState().allBillsList.toList(), kioskBillScreenVarItem.reference.id).length >
                                                                                0
                                                                            ? valueOrDefault<String>(
                                                                                getJsonField(
                                                                                  functions
